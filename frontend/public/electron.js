...
function createWindow () {
  ...
  killProcessIn10022();
  const jarPath = path.resolve(__dirname,'..','..','..','public', 'backend_jar', 'encodedecodestepbystep-0.0.1-SNAPSHOT.jar'); //TODO descomentar para build final
  console.log(jarPath);

  try {
    fs.writeFileSync('myfile.txt', jarPath, 'utf-8');
  }catch(e){
  }
