...
export class Icon {
  ...
  static TransformTo = (props: IconProps) => {
    return <FaArrowAltCircleRight size={props.size} color={props.color} />;
  };

  static Next = (props: IconProps) => {
    return <MdArrowForward size={props.size} color={props.color} />;
  };

  static Back = (props: IconProps) => {
    return <MdArrowBack size={props.size} color={props.color} />;
  };

  static Finish = (props: IconProps) => {
    return <BsFillSkipEndFill size={props.size} color={props.color} />;
  };
  ...
  static Down = (props: IconProps) => {
    return <BsArrowDownShort size={props.size} color={props.color} />;
  };
